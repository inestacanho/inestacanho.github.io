...
This project was created as part of the 02806 Social Data Analysis and Visualization at the Technical University of Denmark (DTU). Our group - whcih includes Inês Tacanho: (s232669), Raquel Marques (s243636) and Sree Keerthi Desu (243933) - has explored San Francisco crime data to uncover patterns and trends that could be useful for mainly tourists visiting the city.
...
Our goal is not just to analyze crime trends but to provide valuable information that could help tourists make informed decisions while visiting San Francisco.